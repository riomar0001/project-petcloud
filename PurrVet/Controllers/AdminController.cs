...
namespace PetCloud.Controllers {
    public class AdminController : Controller {
        ...
        public AdminController(ApplicationDbContext context, GraphServiceClient graphServiceClient, IWebHostEnvironment hostEnvironment, SmsReminderService smsService, EmailService emailService) {
            _context = context;
      ...
      int page = 1) {
        ...
        public IActionResult EditAppointmentsGroup(int groupId, string GroupDate, string GroupTime, List<Appointment> appointments) {
            ...
            if (group.Status == "Finalized" && role != "Admin")
        ...
        public IActionResult Profile() {
            ...
            var adminUser = _context.Users.FirstOrDefault(u => u.UserID == userId && u.Type == "Admin");
            if (adminUser == null)
                return NotFound();
